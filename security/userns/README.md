...
5. Now try running a new container in privileged mode.
  ...
  As stated in the error response, *privileged* containers are not currently supported with user namespaces. But namespaces can be disabled by using the 'host' namespace:
